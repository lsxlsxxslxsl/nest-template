...
const log4jsConfig = {
  ...
  categories: {
    ...
    info: { appenders: ['console', 'errors'], level: 'INFO' },
    access: { appenders: ['console', 'errors'], level: 'INFO' },
    http: { appenders: ['console', 'access'], level: 'DEBUG' },
    server: { appenders: ['console', 'warn'], level: 'WARN' },
    exec: { appenders: ['console', 'errors'], level: 'ERROR' },
  },
